...
%%
%% Lines followed by "%% REQUIRED" contaings options that the user 
%% should provide
%%
...
\addbibresource{Bibliography/thesis.bib} %% REQUIRED. You may substitute "thesis" with another, or several comma separated, *.bib files
