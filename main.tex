...
\citationstyle{apa} %% REQUIRED. Citation style, see https://www.overleaf.com/learn/latex/biblatex_citation_styles for all available styles, some examples: ieee, apa, nature.
...
\sloppy %% Prevents long words to flow into the margin, bu applying a "sloppy" hyphenation method. Remove if do not want this.
